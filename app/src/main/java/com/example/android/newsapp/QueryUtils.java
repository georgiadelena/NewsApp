...
public class QueryUtils {
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            // Create a JSONObject from the JSON string that came as a response
            ...
            JSONArray jsonResultsArray = jsonResults.getJSONArray("results");
            ...
            for (int i = 0; i < jsonResultsArray.length(); i++) {
                ...
                if (tagsArray.length() == 0) {
                    ...
                    for (int j = 0; j < tagsArray.length(); j++) {
                        ...
                        author += authorObject.optString("webTitle");
                    }
                }

                // Create a new {@link News} object with the title, section, date,
                // and url from the JSON response.
                News newsItem = new News(title, section, date, url, author);
